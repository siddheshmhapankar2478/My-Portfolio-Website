    ...
    <>
          <div className="flex items-center justify-between w-full  min-h-screen bg-light dark:bg-dark dark:text-light">
            <div className="w-1/2 h-[80vh] flex justify-center">
              <Image src={"/images/home/developer-pic-1.png"} priority quality={100} alt={"My_Image"} className="w-full" width={300} height={300}  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"/>
            </div>

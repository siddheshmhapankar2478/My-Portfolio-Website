...
export default function Home(){
  return (
    <>
          <div className="flex items-center justify-between w-full  min-h-screen bg-light dark:bg-dark dark:text-light lg:flex-col-reverse md:flex-col ">
            <div className="w-1/2 sm:h-auto h-[80vh] flex justify-center  md:w-3/4 sm:w-3/4 sm:mx-auto lg:mx-auto md:mx-auto md:justify-center sm:justify-center">
            ...
            <div className='w-1/2 md:w-full sm:w-full flex flex-col items-center self-center mb-6 md:mx-2 sm:mx-2 md:mb-2 sm:mb-2 md:justify-center sm:justify-center mx-auto'>
              ...
              <AnimatedText text="Turning Vision Into Reality With Code And Design." className={"text-left my-2 md:text-center sm:text-center"}/>
              </div>
              <p className="my-4 mr-20 md:mr-0 sm:mr-0 md:w-5/6 sm:w-5/6 text-base font-medium md:text-center sm:text-center md:text-sm sm:text-sm">As a skilled full-stack developer, I am dedicated to turning ideas into innovative web applications. 
                Explore my latest projects and articles, showcasing my expertise in React.js and web development.</p>
                <div className='flex items-center self-start my-4  md:self-center sm:self-center '>
                ...
                <Link href={"mailto:siddheshmhapankar2478@gmail.com"} target='_blank' className={"bg-dark text-light dark:bg-light dark:text-dark px-6 py-2 md:px-4 sm:px-4 md:py-2 sm:py-2 rounded-lg text-lg md:text-base sm:text-base font-semibold border-2 border-transparent hover:bg-light hover:text-dark hover:border-dark dark:hover:bg-dark dark:hover:text-light dark:hover:border-light md:my-2 sm:my-3"}>Contact</Link>
              </div>
            </div>
          </div>

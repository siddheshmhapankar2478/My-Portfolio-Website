...
const Details = ({type,time,place,info}) => {
    ...
    return (
        <li ref={ref} className='my-8 w-3/5 mx-auto first:mt-0 last:mb-0 flex flex-col justify-between'>
...
const Education = () => {
  ...
  return (
    <div className="my-64 mb-96 ">
        <h1 className="font-bold text-8xl text-center mb-32 w-full">Education</h1>
